...
set output '../plots_de/plot_jhu_cwa_cases_7d.png'
...
set format x "%d/%m"
set output '../plots_en/plot_jhu_cwa_cases_7d.png'
...
set label 3 at graph 0.50, 0.83 "{/Linux-Libertine-O-Bold and the new infections reported by the JHU per day}" center textcolor ls 0
set label 4 at graph 0.50, 0.78 update_str center textcolor ls 0
