...
plot  \
  ...
  \
  "<awk -F, 'BEGIN{a=0;b=0;c=0}{if (NR>1) {a=$1;c=b;b=$3; print a, b, b-c}}' ../data_CWA/diagnosis_keys_statistics.csv" using 1:2:(sprintf("{/*0.85 %i}", $2)) with labels point ls 2 ps 0.0 center offset char -0.55, 0.75 tc ls 10 notitle
