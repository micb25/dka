...
set output '../plots_de/plot_num_keys_submitted_last_6_weeks.png'
...
plot  \
  ...
  \
  "<awk -F, 'BEGIN{a=0;b=0;c=0}{if (NR>1) {a=$1;c=b;b=$4; print a, b, b-c}}' ../data_CWA/diagnosis_keys_statistics.csv" using 1:2:(sprintf("%i", $2)) with labels font ",9" rotate by 90 point ls 2 ps 0.0 center offset char -0.55, 0.45 tc ls 10 notitle

##################################### English

set format x "%d/%m"
set output '../plots_en/plot_num_keys_submitted_last_6_weeks.png'
