...
plot  \
  ...
  \
  "<awk -F, 'BEGIN{a=0;b=0;c=0}{if (NR>1) {a=86400*int($1/86400);c=b;b=$3; print a, b, b-c}}' ../data_JHU/cases_germany_jhu.csv" using 1:2:(sprintf("%i", $2)) with labels font ",8" rotate by 90 point ls 2 ps 0.0 center offset char -0.6, 0.45 tc ls 10 notitle
