...
plot  \
  ...
  \
  "<awk -F, '{if (NR > 1) {print $1,100*$4}}' ../data_CWA/correlation_CWA_RKI.csv" using 1:2:(column(2)>0?sprintf("%.1f%%", column(2)):"") with labels font ",12" rotate by 90 offset -0.02, graph 0.05 ls 8 
